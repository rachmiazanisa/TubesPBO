...
<body>
	<?php
		...
		$sql = "select id_assignment, tanggal, id_mhs, link_jawaban, nilai from Assignment where substring(id_assignment,1,12) = 'tg" . $_SESSION['id_dosen'] . "';";
	...
	<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
		...
		<input type="hidden" name="id_assignment" value="<?php echo $result['id_id_assignment'] ?>">
